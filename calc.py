...
process = tkinter.StringVar()           #显示面板显示结果2，用于显示计算过程
process.set('')

label = tkinter.Label(root,font = ('微软雅黑',20),bg = '#00EE00',bd ='9',fg = '#828282',anchor = 'se',textvariable = process)
label.place(width = 280,height = 170)
label2 = tkinter.Label(root,font = ('微软雅黑',30),bg = '#EE0000',bd ='9',fg = 'black',anchor = 'se',textvariable = result)
...
#   c = b[0:10]                     #所有的运算结果取9位数
    ...
    process.set(computrStr)         #将运算过程显示到屏幕2
    lists.clear()                   #清空列表内容
